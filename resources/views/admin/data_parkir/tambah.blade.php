...
<div class="col-lg-12">
    <div class="card align-content-center">
        ...
        <div class="card-body card-block">
            <form action="/dataparkir" method="POST" class="">
                @csrf
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-map-marker"></i></div>
                        <input type="text" id="lokasi" name="parkiran" placeholder="Lokasi" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-database"></i></div>
                        <input type="kapasitas" id="kapasitas" name="kapasitas" placeholder="Kapasitas" class="form-control">
                    </div>
                </div>
