        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('parkir') }}"> <i class="menu-icon fa fa-plus-circle"></i>Parkir Masuk </a>
                    </li>
                    <li>
                        <a href="{{ url('karcis') }}"> <i class="menu-icon fa fa-newspaper-o"></i>Karcis </a>
                    </li>
                    <li>
                        <a href="{{ url('laporan') }}"> <i class="menu-icon fa fa-file-text-o"></i>Laporan </a>
                    </li>
                    <li>
